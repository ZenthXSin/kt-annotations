...
class ContentScanner {
    ...
    private val knownFqn = mapOf(
        ...
        "ItemModule" to "mindustry.world.modules.ItemModule",
        "LiquidModule" to "mindustry.world.modules.LiquidModule",
        "PowerModule" to "mindustry.world.modules.PowerModule",
        "BulletType" to "mindustry.entities.bullet.BulletType",
        "IntSeq" to "arc.struct.IntSeq",
        ...
        "PowerGraph" to "mindustry.world.blocks.power.PowerGraph",
        "AmbientSource" to "mindustry.audio.AmbientSource",
        "Controllable" to "mindustry.logic.Controllable",
        "Displayable" to "mindustry.ui.Displayable",
        "Senseable" to "mindustry.logic.Senseable",
        "Settable" to "mindustry.logic.Settable",
        "LAccess" to "mindustry.logic.LAccess",
        "Trail" to "mindustry.graphics.Trail",
        "UnlockableContent" to "mindustry.ctype.UnlockableContent",
        "Content" to "mindustry.ctype.Content",
        "Ranged" to "mindustry.logic.Ranged",
        "CommandAI" to "mindustry.ai.types.CommandAI",
        "Player" to "mindustry.gen.Player",
        "Table" to "arc.scene.ui.layout.Table",
        "Teamc" to "io.eve.vanilla.gen.Teamc",
        ...
        "Liquid" to "mindustry.type.Liquid",
        "Trail" to "mindustry.graphics.Trail",
        "TrailNode" to "mindustry.graphics.Trail",
    )
